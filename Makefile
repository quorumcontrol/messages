...
go: build/go/v2/community/community.pb.go build/go/v2/config/config.pb.go build/go/v2/services/services.pb.go build/go/v2/signatures/signatures.pb.go build/go/v2/transactions/transactions.pb.go build/go/v2/bridge/bridge.pb.go
...
build/go/v2/%.pb.go: src/%.proto ${FIRSTGOPATH}/src/github.com/gogo/protobuf/protobuf
	protoc -I=src -I=${FIRSTGOPATH}/src/github.com/gogo/protobuf/protobuf --gogofaster_out=Mgoogle/protobuf/any.proto=github.com/gogo/protobuf/types,paths=source_relative,plugins=grpc:build/go/v2 $<
