...
func (*PublicKeySet) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{0} }
...
type NotaryGroup struct {
	...
	ValidatorGenerators []string        `protobuf:"bytes,6,rep,name=validator_generators,json=validatorGenerators" json:"validator_generators,omitempty"`
	Transactions        []string        `protobuf:"bytes,7,rep,name=transactions" json:"transactions,omitempty"`
	Signers             []*PublicKeySet `protobuf:"bytes,8,rep,name=signers" json:"signers,omitempty"`
	BootstrapAddresses  []string        `protobuf:"bytes,9,rep,name=bootstrap_addresses,json=bootstrapAddresses" json:"bootstrap_addresses,omitempty"`
}
...
func (*NotaryGroup) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{1} }
...
var fileDescriptorConfig = []byte{
	...
	,
}
